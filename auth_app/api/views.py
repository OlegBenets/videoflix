...
class RegistrationView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            data = {
                "user": {"id": saved_account.pk, "email": saved_account.email, "username": saved_account.username},
                "token": token,
            }
...
class CookieTokenObtainPairView(TokenObtainPairView):
    """
    View to obtain access and refresh tokens using email and password.
    """
...
class CookieTokenLogoutView(APIView):
    """
    View to log out user and delete token cookies.
    """
...
class PasswordResetView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response(
                {"detail": "An email has been sent if the account exists."},
                status=status.HTTP_200_OK,
            )
